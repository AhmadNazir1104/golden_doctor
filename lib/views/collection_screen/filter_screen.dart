                    ...
                    GridView.builder(
                        ...
                        itemBuilder: (context, valueIndex) {
                          return CheckboxListTile.adaptive(
                            value: localFilterWatch.contains(filterdata[index]["values"][valueIndex]),
                            title: Text(
                            ...
                            onChanged: (value) {
                              ...
                              temp.contains(filterdata[index]["values"][valueIndex])?
                              temp.remove(
                                  filterdata[index]["values"][valueIndex]):
                                  temp.add(
                                  filterdata[index]["values"][valueIndex]);
                                  localFilterRead.state = [...localFilterRead.state];
